...
// Import category and subcategory routes
...
adminRoutes.use('/category', passport.checkAuthIsDone, categoryRoute);
adminRoutes.use('/subCategory', passport.checkAuthIsDone, subCategoryRoute);
adminRoutes.use('/extraCategory', passport.checkAuthIsDone, extraCategoryRoute);
adminRoutes.use('/product', passport.checkAuthIsDone, productRoute);
